  ...
  return (
    <section className="relative z-10 -mt-6 bg-white" aria-label="Company statistics">
      <div className="section-wrap section-pad">
        <div className="grid divide-y divide-line overflow-hidden rounded-2xl border border-line bg-white shadow-[0_20px_50px_rgba(7,26,43,0.08)] sm:grid-cols-2 sm:divide-x lg:grid-cols-5 lg:divide-y-0">
          {stats.map((stat) => (
